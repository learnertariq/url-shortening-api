    ...
    <footer className="section section-footer">
      <div className="container">
        <div className="footer">
          <section className="footer__section footer__brand-section">
          ...
          {list.map((item) => (
            <section className={"footer__section " + item.className}>
              <h2 className="footer__section__heading">{item.heading}</h2>

              <ul className="list footer__list">
                {item.links.map((link) => (
                  <li className="list__item footer__item">
                    <a href={link.url} className="link footer__link">
                      {link.title}
                    </a>
                  </li>
                ))}
